...
router.post('/ambassador-register', authLimiter, (0, error_1.asyncHandler)(auth_controller_1.authController.ambassadorRegister.bind(auth_controller_1.authController)));
